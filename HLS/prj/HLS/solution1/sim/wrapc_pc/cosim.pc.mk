...
$(ObjDir)/HLS_HelloWorld_tb.cpp_pre.cpp.tb.o : HLS_HelloWorld_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling HLS_HelloWorld_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/HLS_HelloWorld.cpp_pre.cpp.tb.o : HLS_HelloWorld.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling HLS_HelloWorld.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
