...
if {[file isfile flash_led.autotvin.dat]} {
	file delete -force flash_led.autotvin.dat
}

if {[file isfile flash_led.autotvout.dat]} {
	file delete -force flash_led.autotvout.dat
}
