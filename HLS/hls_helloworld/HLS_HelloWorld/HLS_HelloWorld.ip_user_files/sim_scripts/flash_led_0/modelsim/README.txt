...
#
# Generated by export_simulation on Sat May 13 14:32:39 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './flash_led_0.sh' script.

./flash_led_0.sh -reset_run
...
./flash_led_0.sh -noclean_files

For more information on the script, please type './flash_led_0.sh -help'.
