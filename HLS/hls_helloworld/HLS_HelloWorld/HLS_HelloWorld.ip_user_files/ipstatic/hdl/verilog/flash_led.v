...
(* CORE_GENERATION_INFO="flash_led,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.967750,HLS_SYN_LAT=100000001,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=32,HLS_SYN_LUT=70,HLS_VERSION=2018_3}" *)
...
assign exitcond_fu_68_p2 = ((t_V_reg_51 == 27'd100000000) ? 1'b1 : 1'b0);

assign i_V_fu_74_p2 = (t_V_reg_51 + 27'd1);

assign led_o_V = r_V_reg_86;

assign r_V_fu_62_p2 = (led_i_V_in_sig ^ 1'd1);

assign tmp_fu_80_p2 = ((t_V_reg_51 == 27'd99999998) ? 1'b1 : 1'b0);
